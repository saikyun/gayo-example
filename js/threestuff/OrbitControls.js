...
this.panDelta = new Vector2();
  ...
  var dollyStart = new Vector2();
	...
	scope.handleMouseDownRotate = function( event ) {
	...
	scope.handleMouseDownPan = function( event ) {

		scope.panStart.set( event.clientX, event.clientY );

	}

	scope.handleMouseMoveRotate = function( event ) {
	...
	scope.handleMouseMovePan = function( event ) {
	...
	scope.handleMouseWheel = function( event ) {
...
var MapControls = function ( object ) {

	OrbitControls.call( this, object );
