...
var GLTFLoader = ( function () {
	...
	GLTFLoader.prototype = {
		...
		parse: function ( data, path, onLoad, onError ) {
		  ...
		  if (this.textureLoader) {
		    parser.textureLoader = this.textureLoader;
		  }

		  if (this.fileLoader) {
		    parser.fileLoader = this.fileLoader;
		  }
	...
	function resolveURL( url, path ) {
	  ...
	  if (window.preloaded && window.preloaded.get(url)) {
	    if (url.endsWith(".bin")) {
	      return window.preloaded.get(url);
	    } else {
	      return url;
	    }
	  }
	...
	GLTFParser.prototype.loadTexture = function ( textureIndex ) {
	  ...
	  window.jjj = json;
	  	  window.td = textureDef;
	  window.sourceURI = sourceURI;
